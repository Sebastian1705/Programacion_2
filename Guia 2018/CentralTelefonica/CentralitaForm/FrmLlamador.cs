...
{
    /*q. Los formularios FrmLlamador y FrmMostrar:
    i. Recibirán en su constructor a la Centralita creada en FrmMenu.
    ii. FrmLlamador tendrá una propiedad de sólo lectura que expondrá dicha Centralita, a
    ...
    public partial class FrmLlamador : Form
    {
        ...
        {
            cmbFranja.DataSource = Enum.GetValues(typeof(CentralitaAbstract.Provincial.Franja));
        }
