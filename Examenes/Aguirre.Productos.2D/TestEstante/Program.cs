...
namespace TestEstante
{
    class Program
    {
        public static int OrdenarProductos(Productos prodUno, Productos prodDos)
        {
        ...
        static void Main(string[] args)
        {
            ...
            Harina h1 = new Harina(102, 37.5f, Productos.EMarcaProducto.Favorita,
            Harina.ETipoHarina.CuatroCeros);
            Harina h2 = new Harina(103, 40.25f, Productos.EMarcaProducto.Favorita,
            Harina.ETipoHarina.Integral);
            Galletita g1 = new Galletita(113, 33.65f, Productos.EMarcaProducto.Pitusas, 250f);
            Galletita g2 = new Galletita(111, 56f, Productos.EMarcaProducto.Diversion, 500f);
            Jugo j1 = new Jugo(112, 25f, Productos.EMarcaProducto.Naranju, Jugo.ESaborJugo.Pasable);
            Jugo j2 = new Jugo(333, 33f, Productos.EMarcaProducto.Swif, Jugo.ESaborJugo.Asqueroso);
            ...
            est1.GetValorEstante(Productos.ETipoProducto.Galletita));
            ...
            est1 = est1 - Productos.ETipoProducto.Galletita;
            ...
            est2 -= Productos.ETipoProducto.Todos;
            Console.WriteLine("Contenido Estante2:\n{0}", Estante.MostrarEstante(est2));
            Console.ReadLine();
        }
    }
